          ...
          <div style={{
            ...
            {authView === 'login' ? (
              ...
              <form onSubmit={handleRegister}>
                <h3 style={{ fontFamily: "'Times New Roman', Times, serif", textAlign: 'center', marginBottom: '1.5rem', color: 'var(--reg-heading)', fontWeight: '800', fontSize: '1.4rem' }}>
                  FACULTY REGISTRATION
                </h3>
                <label style={{ fontSize: '0.75rem', color: 'var(--reg-label)', fontWeight: '800', letterSpacing: '1px', textTransform: 'uppercase' }}>FULL NAME</label>
                <input className="input-field" style={{ background: 'var(--reg-input-bg)', color: 'var(--reg-input-text)', borderRadius: '9999px', padding: '12px 20px', border: 'var(--reg-input-border)', marginTop: '4px', marginBottom: '1rem' }} placeholder="e.g. Dr. John Doe" value={regForm.name} onChange={(e) => setRegForm({ ...regForm, name: e.target.value })} required />
                <label style={{ fontSize: '0.75rem', color: 'var(--reg-label)', fontWeight: '800', letterSpacing: '1px', textTransform: 'uppercase' }}>USERNAME</label>
                <input className="input-field" style={{ background: 'var(--reg-input-bg)', color: 'var(--reg-input-text)', borderRadius: '9999px', padding: '12px 20px', border: 'var(--reg-input-border)', marginTop: '4px', marginBottom: '1rem' }} placeholder="Choose username" value={regForm.username} onChange={(e) => setRegForm({ ...regForm, username: e.target.value })} required />
                <label style={{ fontSize: '0.75rem', color: 'var(--reg-label)', fontWeight: '800', letterSpacing: '1px', textTransform: 'uppercase' }}>PASSWORD</label>
                <input type="password" className="input-field" style={{ background: 'var(--reg-input-bg)', color: 'var(--reg-input-text)', borderRadius: '9999px', padding: '12px 20px', border: 'var(--reg-input-border)', marginTop: '4px', marginBottom: '1rem' }} placeholder="Create password" value={regForm.password} onChange={(e) => setRegForm({ ...regForm, password: e.target.value })} required />
                <label style={{ fontSize: '0.75rem', color: 'var(--reg-label)', fontWeight: '800', letterSpacing: '1px', textTransform: 'uppercase' }}>CONFIRM PASSWORD</label>
                <input type="password" className="input-field" style={{ background: 'var(--reg-input-bg)', color: 'var(--reg-input-text)', borderRadius: '9999px', padding: '12px 20px', border: 'var(--reg-input-border)', marginTop: '4px', marginBottom: '1.2rem' }} placeholder="Repeat password" value={regForm.confirmPassword} onChange={(e) => setRegForm({ ...regForm, confirmPassword: e.target.value })} required />
                <button type="submit" style={{ width: '100%', background: 'linear-gradient(180deg, #3b3e8c 0%, #2e3075 100%)', color: '#ffffff', border: '2px solid var(--reg-label)', padding: '14px', borderRadius: '9999px', fontSize: '0.95rem', fontWeight: '800', cursor: 'pointer' }}>REGISTER ACCOUNT</button>
